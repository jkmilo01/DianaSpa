    ...
    <div class="service_wrapper">
      <div class="row">
		...
		<div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-building-o "></i></span> </div>
		  ...
		  <div class="col-md-3">
		<div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-eye"></i></span> </div>
          <div class="service_block">
...
<footer class="footer_wrapper" id="contact">
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © reserved,    Template by <a href=""></a>. </span> </div>
  </div>
</footer>
