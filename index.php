...
<body>
                        ...
                        <div class="d-flex justify-content-around">
                            <div class="col-md-11">
                                <ul class="nav navbar-nav" id="mainNav">
                                    <li class="active"><a href="#home" class="scroll-link" lang="en">Home</a></li>
                                    <li class="active"><a href="#home" class="scroll-link" lang="es">Inicio</a></li>
                                    <li><a href="#aboutUs" class="scroll-link" lang="en">About Me</a></li>
                                    <li><a href="#aboutUs" class="scroll-link" lang="es">Acerca de</a></li>
                                    <li><a href="#service" class="scroll-link" lang="en">Our Services</a></li>
                                    <li><a href="#service" class="scroll-link" lang="es">Servicios</a></li>
                                    <li><a href="#Portfolio" class="scroll-link" lang="en">Gallery</a></li>
                                    <li><a href="#Portfolio" class="scroll-link" lang="es">Galería</a></li>
                                    <li><a href="#experience" class="scroll-link" lang="en">Testimonial</a></li>
                                    <li><a href="#experience" class="scroll-link" lang="es">Testimonios</a></li>
                                    <li><a href="#contact" class="scroll-link" lang="en">Contact</a></li>
                                    <li><a href="#contact" class="scroll-link" lang="es">Contacto</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="videobg2">
                                <div class="video-container2">
                                    ...
                                    <video autoplay loop muted>
                                        <source src="Video/pexels-anna-tarazevich-5636880.mp4" type="video/mp4">
                                    </video>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Lorem ipsum dolor sit amet, quo meis voluptaria, erant bonorum albucius et per, ei
                                ...
                                constituam ei vel. Te sit malorum ceteros repudiandae, ne tritani adipisci vis.</p>

                            <p>Lorem ipsum dolor sit amet, voluptaria, erant bonorum albucius et per, ei meis audire
                                placerat eu, te eos porro veniam. An everti maiorum detracto mea. Lorem ipsum dolor sit
                                amet, consectetur Morbi sagittis, sem quisci ipsum gravida tortor orci ipsum gravida
                                tortor.
                            </p>
    ...
    <section id="service">
        <div class="container">
            ...
            <div class="service_wrapper">
                <div class="row">
                    <div class="col-md-3">
                        <div class="service_icon delay-03s animated wow  zoomIn"> <span id="arbolito"><i
                                    class="fa fa-tree"></i></span> </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="service_block">
                            <h3 class="animated fadeInUp wow">Electrostimulation</h3>
                            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. </p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="service_block">
                            ...
                            <h3 class="animated fadeInUp wow">Cavitation</h3>
                            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. </p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="service_block">
                            ...
                            <h3 class="animated fadeInUp wow">Lymphatic Drainage Massage</h3>
                            <p class="animated fadeInDown wow">Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. </p>
                        </div>
                    </div>
    ...
    <footer class="footer_wrapper" id="contact">
        ...
        <div class="container">
            <div class="footer_bottom"><span>Copyright © reserved, Developed by <a href="">ESD</a>. </span> </div>
        </div>
    </footer>
